...
*This is part of a series. I recommend starting with [Part 1](/posts/negative-splitting-ultras/) about why I negative split. This part will go into how I think and reason about the execution itself on a low level.*
...
1. Even when I had a strong finish, my slowest miles were 60-80% into a race, and often 2-5 minutes a mile slower than earlier in the race.

2. I hypothesized that if I could run my fastest and strongest miles 80% into the race by absolute pace, almost everything else will take care of itself. The slower first half pace will both be easier to beat, and I'll have more reserves to do it.
...
![Green line pacing chart](/images/gl-chart-1.png)
...
![Green line with dips](/images/gl-chart-2.png)
...
On the mental side, I'm a fan of Dr. Jim Loehr's concept of the [energy quadrants](https://www.audible.com/pd/Mental-Toughness-Training-Audiobook/B00NPJH81M) applied to sports that have active periods and rest periods. In short, he describes staying in a "high positive" state of calm and confident engagement during active competition, but dropping to a "low positive" state of peaceful relaxation in between rounds. Ultras don't work this way because of their length. I've found focusing on combining the two and slowly dialing from low positive to high positive over the course of the race is the right approach. It keeps cortisol and the endocrine system as dialed back as possible for most of the race, but in the second half I slowly move to a higher energy state as I push more and more to the finish.
